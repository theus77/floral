...
Configure::write('exportedPath','/Shared Items/Public/drupal/Photos/');
Configure::write('exportedUrl','/../Photos/');
Configure::write('libsPath','../../../libs/');


function encodeUuid($inUuid){
...
Configure::write('aperturePath', '/var/aperture/');
